Tareas ejecutadas con 1 driver en cada proceso:
```
INFO:__main__:Iniciando ProcessPoolExecutor con 4 workers...
INFO:__main__:Iniciando Servidor B en 127.0.0.2:8000
INFO:__main__:Recibida tarea: {'url': 'http://cow.net/cows/'}
INFO:__main__:[PID 17401] Iniciando análisis para: http://cow.net/cows/
INFO:__main__:[PID 17402] Iniciando análisis para: http://cow.net/cows/
INFO:__main__:[PID 17403] Iniciando análisis para: http://cow.net/cows/
INFO:processor.image_processor:Iniciando procesamiento de imágenes...
INFO:processor.screenshot:Tomando screenshot de http://cow.net/cows/...
INFO:processor.performance:Analizando rendimiento de http://cow.net/cows/...
INFO:processor.image_processor:Se encontraron 3 imágenes. Procesando las primeras 5...
INFO:processor.screenshot:Screenshot de http://cow.net/cows/ completado.
INFO:processor.image_processor:Se generaron 3 thumbnails.
INFO:__main__:Tiempo transcurrido para el analisis: 0:00:06.518722
INFO:__main__:Analisis terminado para http://cow.net/cows/
```
Tareas ejecutadas secuencialmente con 1 driver:
```
INFO:__main__:Iniciando ProcessPoolExecutor con 4 workers...
INFO:__main__:Iniciando Servidor B en 127.0.0.2:8000
INFO:__main__:Recibida tarea: {'url': 'http://cow.net/cows/'}
INFO:__main__:[PID 18684] Iniciando análisis para: http://cow.net/cows/
INFO:processor.screenshot:Tomando screenshot de http://cow.net/cows/...
INFO:processor.screenshot:Screenshot de http://cow.net/cows/ completado.
INFO:processor.performance:Analizando rendimiento de http://cow.net/cows/...
INFO:processor.image_processor:Iniciando procesamiento de imágenes...
INFO:processor.image_processor:Se encontraron 3 imágenes. Procesando las primeras 5...
INFO:processor.image_processor:Se generaron 3 thumbnails.
INFO:__main__:[PID 18684] Análisis completado para: http://cow.net/cows/
INFO:__main__:Tiempo transcurrido para el analisis: 0:00:06.613459
INFO:__main__:Analisis terminado para http://cow.net/cows/
```

El codigo involucrado para secuencial
```python
import argparse
import socketserver
import json
...
# --- Funciones de Tarea (CPU-Bound) ---
# Estas funciones se ejecutarán en el ProcessPoolExecutor
def run_full_analysis(url: str, type: str):
    """
    Función que se ejecuta en un proceso separado.
    Debe ser una función simple, no un método de clase,
    para que sea fácilmente "picklable".
